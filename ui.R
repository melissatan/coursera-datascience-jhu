...
shinyUI(fluidPage(
  ...
  h4("(sadly, about as accurate as a human one.)", align="center"),
  ...
  fluidRow(
    column(5, offset=1,
           ...
           wellPanel(
             ...
             p("To get started, fill in the text box.
                    If you're in 'Classic' mode, click the button.
                    For 'Autocomplete', a word should appear by itself."),
    ...
    column(5,
           selectInput("lang",
                       label = "What language should we use?",
           ...
           checkboxInput("safemode",
                         label = "Turn on safe mode (remove profanity)",
                         value = TRUE),
           br(),
           p("Source code can be found ",
             a("here", href="https://github.com/melissatan/dscapstone"),
             align="right")
    )
  )
))
